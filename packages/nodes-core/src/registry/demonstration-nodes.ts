...
export function createDemonstrationNodes(): NodeDefinition[] {
  ...
  // Solid Primitives
  nodes.push(
    createDemoNode('AdvancedBox', 'Solid', 'Primitives', 'Advanced parametric box with rounded corners and chamfers'),
    createDemoNode('ParametricSphere', 'Solid', 'Primitives', 'Parametric sphere with UV controls'),
    createDemoNode('AdvancedCylinder', 'Solid', 'Primitives', 'Cylinder with variable radius and taper'),
    createDemoNode('ParametricCone', 'Solid', 'Primitives', 'Cone with elliptical base and variable angle'),
  ...
  // Advanced Features
  nodes.push(
    createDemoNode('VariableFillets', 'Features', 'Fillets', 'Variable radius fillets with multiple control points'),
    ...
    createDemoNode('RectangularPocket', 'Features', 'Pockets', 'Rectangular pocket with rounded corners'),
    createDemoNode('CircularPocket', 'Features', 'Pockets', 'Circular pocket with depth control'),
  );

  // Boolean Operations
  nodes.push(
    createDemoNode('IntelligentUnion', 'Boolean', 'Operations', 'Union with automatic tolerance adjustment'),
    createDemoNode('IntelligentSubtraction', 'Boolean', 'Operations', 'Subtraction with gap healing'),
    createDemoNode('IntelligentIntersection', 'Boolean', 'Operations', 'Intersection with surface blending'),
  ...
  nodes.push(
    createDemoNode('AdvancedMove', 'Transform', 'Position', 'Move with coordinate system alignment'),
    createDemoNode('AdvancedRotate', 'Transform', 'Position', 'Rotate with axis and angle control'),
    createDemoNode('NonUniformScale', 'Transform', 'Position', 'Scale with different X, Y, Z factors'),
    createDemoNode('LinearPattern', 'Transform', 'Patterns', 'Linear pattern with direction control'),
