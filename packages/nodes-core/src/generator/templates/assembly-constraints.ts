...
export const constraintTemplates: NodeTemplate[] = [
  {
    ...
    parameters: [
      { name: 'tolerance', type: 'number', default: 0.001, min: 0, max: 1 }
    ],
    inputs: [
...

  {
    ...
    parameters: [],
    inputs: [
      { name: 'entity', type: 'Shape', required: true }
    ],
    outputs: [
      { name: 'constrained', type: 'Shape' },
      { name: 'constraint', type: 'Constraint' }
...
export const mateTemplates: NodeTemplate[] = [
...

  {
    ...
    parameters: [
      { name: 'freeRotation', type: 'boolean', default: true }
    ],
    inputs: [
...
export const jointTemplates: NodeTemplate[] = [
...

  {
    ...
    parameters: [
      { name: 'coneAngle', type: 'number', default: 45, min: 0, max: 180 }
    ],
    inputs: [
      { name: 'part1', type: 'Shape', required: true },
      { name: 'part2', type: 'Shape', required: true },
...

  {
    ...
    parameters: [
      { name: 'pitch', type: 'number', default: 1, min: 0.01, max: 100 }
    ],
    inputs: [
      { name: 'part1', type: 'Shape', required: true },
      { name: 'part2', type: 'Shape', required: true },
...

  {
    ...
    parameters: [
      { name: 'module', type: 'number', default: 1, min: 0.1, max: 100 }
    ],
    inputs: [
...
export const assemblyPatternTemplates: NodeTemplate[] = [
  {
    ...
    parameters: [
      { name: 'patternType', type: 'enum', options: ['linear', 'circular', 'mirror'], default: 'linear' },
...

  {
    ...
    outputs: [
      { name: 'subAssembly', type: 'Assembly' }
    ]
  },
...

  {
    ...
    parameters: [
      { name: 'clearance', type: 'number', default: 0, min: 0, max: 100 }
    ],
    inputs: [
      { name: 'assembly', type: 'Assembly', required: true }
    ],
...

  {
    ...
    inputs: [
      { name: 'holes', type: 'Face[]', required: true }
    ],
    outputs: [
      { name: 'fasteners', type: 'Shape[]' }
    ]
  },

  {
    ...
    parameters: [
      { name: 'type', type: 'enum', options: ['bonded', 'no_penetration', 'frictionless'], default: 'no_penetration' },
    ...
    outputs: [
      { name: 'contactSet', type: 'ContactSet' }
    ]
  }
];
