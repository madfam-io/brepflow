...
export const transformOperationTemplates: NodeTemplate[] = [
  {
    ...
    parameters: [
      { name: 'x', type: 'number', default: 0, min: -10000, max: 10000, description: 'X translation' },
      { name: 'y', type: 'number', default: 0, min: -10000, max: 10000, description: 'Y translation' },
      { name: 'z', type: 'number', default: 0, min: -10000, max: 10000, description: 'Z translation' },
      { name: 'copy', type: 'boolean', default: true, description: 'Create copy or move original' }
    ],
    inputs: [
      { name: 'shape', type: 'Shape', required: true, description: 'Shape to move' }
    ],
    outputs: [
      { name: 'moved', type: 'Shape', description: 'Moved shape' }
    ]
  },

  {
    ...
    parameters: [
      { name: 'angle', type: 'number', default: 45, min: -360, max: 360, description: 'Rotation angle in degrees' },
    ...
    outputs: [
      { name: 'rotated', type: 'Shape', description: 'Rotated shape' }
    ]
  },

  {
    ...
    parameters: [
      { name: 'scaleX', type: 'number', default: 1, min: 0.001, max: 1000, description: 'X scale factor' },
      { name: 'scaleY', type: 'number', default: 1, min: 0.001, max: 1000, description: 'Y scale factor' },
      { name: 'scaleZ', type: 'number', default: 1, min: 0.001, max: 1000, description: 'Z scale factor' },
    ...
    outputs: [
      { name: 'scaled', type: 'Shape', description: 'Scaled shape' }
    ]
  },

  {
    ...
    outputs: [
      { name: 'mirrored', type: 'Shape', description: 'Mirrored shape' }
    ]
  },
...

  {
    ...
    parameters: [
      { name: 'alignX', type: 'enum', options: ['none', 'min', 'center', 'max'], default: 'center' },
      { name: 'alignY', type: 'enum', options: ['none', 'min', 'center', 'max'], default: 'center' },
    ...
    outputs: [
      { name: 'aligned', type: 'Shape[]', description: 'Aligned shapes' }
    ]
  },
...

  {
    ...
    parameters: [
      { name: 'method', type: 'enum', options: ['bend', 'twist', 'taper', 'stretch'], default: 'bend' },
...

  {
    ...
    inputs: [
      { name: 'shape', type: 'Shape', required: true },
      { name: 'matrix', type: 'Matrix4x4', required: true, description: '4x4 transformation matrix' }
    ],
    outputs: [
      { name: 'transformed', type: 'Shape' }
    ]
  }
];

// Export all templates
export const allTransformTemplates = [
