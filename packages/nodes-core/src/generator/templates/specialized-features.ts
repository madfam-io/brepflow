...
export const textEngravingTemplates: NodeTemplate[] = [
  {
    ...
    parameters: [
      ...
      { name: 'font', type: 'enum', options: ['Arial', 'Helvetica', 'Times', 'Courier'], default: 'Arial' },
...
export const latticeTemplates: NodeTemplate[] = [
  {
    ...
    parameters: [
      { name: 'cellType', type: 'enum', options: ['cubic', 'gyroid', 'diamond', 'schwarz', 'bcc', 'fcc'], default: 'cubic' },
...

  {
    ...
    occtBinding: 'tpms',
    parameters: [
      { name: 'type', type: 'enum', options: ['gyroid', 'schwarz-p', 'schwarz-d', 'neovius', 'lidinoid'], default: 'gyroid' },
    ...
    inputs: [
      { name: 'boundingBox', type: 'Shape', required: true }
    ],
    outputs: [
      { name: 'tpms', type: 'Shape' }
    ]
  },
...

  {
    ...
    parameters: [
      ...
      { name: 'gradientType', type: 'enum', options: ['linear', 'radial', 'field'], default: 'linear' }
    ],
    inputs: [
      { name: 'boundingShape', type: 'Shape', required: true },
...
export const topologyOptimizationTemplates: NodeTemplate[] = [
...

  {
    ...
    parameters: [
      { name: 'objective', type: 'enum', options: ['min-weight', 'max-stiffness', 'min-stress'], default: 'min-weight' },
...

  {
    ...
    parameters: [
      ...
      { name: 'structureType', type: 'enum', options: ['ribs', 'shells', 'lattice', 'hybrid'], default: 'hybrid' }
    ],
    inputs: [
...

  {
    ...
    parameters: [
      { name: 'analysisType', type: 'enum', options: ['fea-based', 'geometric', 'hybrid'], default: 'geometric' },
...

  {
    ...
    parameters: [
      ...
      { name: 'algorithm', type: 'enum', options: ['greedy', 'genetic', 'simulated-annealing'], default: 'genetic' }
    ],
    inputs: [
      { name: 'parts', type: 'Shape[]', required: true }
    ],
    outputs: [
...
export const organicFormTemplates: NodeTemplate[] = [
...

  {
    ...
    parameters: [
      { name: 'scheme', type: 'enum', options: ['catmull-clark', 'loop', 'doo-sabin'], default: 'catmull-clark' },
      { name: 'levels', type: 'number', default: 2, min: 1, max: 5, step: 1 }
    ],
    inputs: [
      { name: 'controlMesh', type: 'Shape', required: true }
    ],
    outputs: [
      { name: 'subdivided', type: 'Shape' }
    ]
  },
...

  {
    ...
    parameters: [
      { name: 'pattern', type: 'enum', options: ['spots', 'stripes', 'labyrinth', 'holes'], default: 'spots' },
...

  {
    ...
    parameters: [
      { name: 'inspiration', type: 'enum', options: ['bone', 'wood', 'coral', 'leaf-veins'], default: 'bone' },
