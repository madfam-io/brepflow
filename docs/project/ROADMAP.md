...
4. Update README and marketing copy to reflect current capabilities (real OCCT only, limited nodes) until Horizon A concludes.
5. Draft implementation plan for the mock-geometry teardown (factory refactor, Studio/CLI updates, docs) and create work items per chunk.
