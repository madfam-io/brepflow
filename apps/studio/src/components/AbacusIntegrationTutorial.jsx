  ...
  const tutorialSteps = [
    {
      ...
      content: 'You\'ll create a complete parametric abacus using real BrepFlow nodes, parameters, and OCCT geometry processing.',
    ...
    },
    {
      ...
      content: 'First, let\'s explore the BrepFlow Studio. Notice the node editor canvas, toolbars, and viewport areas.',
    ...
    },
    {
      ...
      content: 'To create geometry, we need nodes. The node palette contains all available geometry operations.',
    ...
    },
    {
      ...
      content: 'Let\'s start building our abacus frame. We\'ll create the top horizontal bar using a Box node.',
    ...
    },
    {
      ...
      content: 'Now add the vertical rods. We\'ll use Cylinder nodes for the rods that hold the beads.',
    ...
    },
    {
      ...
      action: 'Duplicate the bead 34 times total (7 beads × 5 rods), positioning them along each rod',
      target: '[data-node-type="Sphere"]',
    ...
    },
    {
      ...
      content: 'Time to see your abacus come to life! Evaluate the node graph to generate real OCCT geometry.',
    ...
    },
    {
      ...
      content: 'Your abacus should now be visible in the 3D viewport! Interact with it to see your creation.',
    ...
    },
    {
      ...
      content: 'Change parameters to see live geometry updates. This is the power of parametric design!',
    ...
    },
    {
      ...
      content: 'You\'ve successfully created a parametric abacus using real BrepFlow Studio with OCCT geometry processing!',
    ...
    <div className="tutorial-overlay">
      <div className="tutorial-panel">
        ...
        <div className="tutorial-hint">
          💡 This is a hands-on tutorial - you'll actually create the abacus using real BrepFlow tools!
        </div>
      </div>
