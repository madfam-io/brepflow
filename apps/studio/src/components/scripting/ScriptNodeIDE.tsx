...
import type {
  ...
  ScriptPermissions,
  ScriptMetadata,
} from '@brepflow/engine-core/src/scripting/types';
import { scriptEngine } from '@brepflow/engine-core/src/scripting/script-engine';
    ...
    try {
      ...
      const mockContext = {
        script: {
          ...
          timeout: <T>(promise: Promise<T>, ms: number) => Promise.race([
            promise,
