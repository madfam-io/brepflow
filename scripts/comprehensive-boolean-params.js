...
const PARAMS_EXPORT_PATH = path.join(__dirname, '../packages/nodes-core/src/nodes/generated/params.ts');
...
function generateComprehensiveParamUtils() {
  ...
  content = content.replace(/\/\/ Generate remaining BooleanParam aliases for comprehensive coverage\s*\nexport const BooleanParam(10[1-9]|1[1-9]\d|[2-9]\d\d) = BoolParam;\s*/g, '');
